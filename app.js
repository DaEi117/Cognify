...
console.log("Cognify – Fix: Buttons nach Prüfen immer sichtbar + Bilder pro Liste (IndexedDB)");
    ...
    reader.onload = (evt) => {
        try {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                // Mehrzeilige Zellen bleiben erhalten
...
// ✅ NEU: Buttons sichtbar halten
function ensureButtonsVisible() {
    bewertung.scrollIntoView({
        behavior: "smooth",
        block: "nearest"
    });
}
...
btnPruefen.onclick = async () => {
    ...
    // ✅ NEU: Nach Layout-Update zu den Buttons scrollen
